 ...
 * @Last Modified time: 2018-02-16 09:39:29
 *
 */
...
$(document).on('click', '#add_new', function(e) {
	...
	var newFiltersExpression = [["formulanumeric: ROUND({custrecord_ap_lodgement_lat},3)","equalto",(parseFloat(lat)).toFixed(3)],"AND",["formulanumeric: ROUND({custrecord_ap_lodgement_long},3)","equalto",(parseFloat(lng)).toFixed(3)],"AND",["custrecord_noncust_location_type","is",ncl_type]];
...
$(document).on('click', '#add_exists', function(e) {
	...
	var upload_url = baseURL + nlapiResolveURL('suitelet', nlapiGetFieldValue('custpage_suitlet_id'), nlapiGetFieldValue('custpage_deploy_id')) + '&params=' + params;
