...
function create_ncl(request, response) {
    ...
    if (request.getMethod() === "GET") {
        ...
        if (!isNullorEmpty(params)) {
            ...
            form.addField('custpage_suitlet_id', 'text', 'Customer ID').setDisplayType('hidden').setDefaultValue(params.id);
            form.addField('custpage_deploy_id', 'text', 'Customer ID').setDisplayType('hidden').setDefaultValue(params.deploy);
            form.addField('custpage_customer_id', 'text', 'Customer ID').setDisplayType('hidden').setDefaultValue(custid);
        } else {
            params = null;
            form.addField('custpage_suitlet_id', 'text', 'Customer ID').setDisplayType('hidden').setDefaultValue(null);
            form.addField('custpage_deploy_id', 'text', 'Customer ID').setDisplayType('hidden').setDefaultValue(null);
            form.addField('custpage_customer_id', 'text', 'Customer ID').setDisplayType('hidden').setDefaultValue(null);
        }
        ...
        form.addField('custpage_ncl_exists', 'text', 'NCL Exists').setDisplayType('hidden');
        ...
        inlineQty += '<div class="col-xs-6 ncl_type_section"><div class="input-group"><span class="input-group-addon">LOCATION TYPE</span><select class="form-control ncl_type" id="ncl_type">';
        ...
        inlineQty += '<div class="col-xs-3"><div class="input-group"><span class="input-group-addon">POSTCODE</span><input id="postcode" readonly class="form-control postcode" /></div></div>';
        ...
        inlineQty += '<th style="vertical-align: middle;text-align: center;" class=""><b>LOCATION NAME</b></th>';

        /**
         * BUILDING/LEVEL/UNIT/SUITE - OR - POSTAL BOX
         */
        inlineQty += '<th style="vertical-align: middle;text-align: center;" class=""><b>LEVEL/UNIT/SUITE</b></th>';

        /**
         * STREET NO. & NAME
         */
        inlineQty += '<th style="vertical-align: middle;text-align: center;" class=""><b>STREET NO. & NAME</b></th>';

        // /**
        //  * CITY
        //  */
        inlineQty += '<th style="vertical-align: middle;text-align: center;" class=""><b>CITY</b></th>';
        // /**
        //  * STATE
        //  */
        inlineQty += '<th style="vertical-align: middle;text-align: center;" class=""><b>STATE</b></th>';
        // /**
        //  * POSTCODE
        //  */
        inlineQty += '<th style="vertical-align: middle;text-align: center;" class=""><b>POSTCODE</b></th>';
        ...
        if (!isNullorEmpty(request.getParameter('custpage_customer_id'))) {
            ...
            nlapiSetRedirectURL('SUITELET', request.getParameter('custpage_suitlet_id'), request.getParameter('custpage_deploy_id'), null, params2);
        } else {
        	nlapiSetRedirectURL('SUITELET', 'customscript_sl_create_new_ncl', 'customdeploy_sl_create_new_ncl', null, null);
        }
