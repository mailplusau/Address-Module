 ...
 * @Last Modified time: 2019-05-07 10:22:01
 *
 */
...
function pageInit() {
	...
	resultSet.forEachResult(function(searchResult) {
		...
		if (default_shipping == 'T' && state_id == zeeLocation) {
...
function saveRecord() {
	...
	for (y = 1; y <= nlapiGetLineItemCount('addresses'); y++) {
		...
		if (!isNullorEmpty(corporate_office_internal_id) && corporate_office_internal_id != 0) {
			...
			// ncl_values[ncl_values.length] = nlapiGetLineItemValue('addresses', 'mailingcode', y);
			// ncl_values[ncl_values.length] = nlapiGetLineItemValue('addresses', 'lat', y);
			// ncl_values[ncl_values.length] = nlapiGetLineItemValue('addresses', 'lng', y);


			// nlapiSubmitField('customrecord_ap_lodgment_location', ncl_id[y], ncl_fields, ncl_values);


			// var noncust_lodgement_loc_record = nlapiLoadRecord('customrecord_ap_lodgment_location', corporate_office_internal_id);
			// noncust_lodgement_loc_record.setFieldValue('custrecord_ncl_mailing_postcode', nlapiGetLineItemValue('addresses', 'mailingcode', y));
			// noncust_lodgement_loc_record.setFieldValue('custrecord_ap_lodgement_lat', nlapiGetLineItemValue('addresses', 'lat', y));
			// noncust_lodgement_loc_record.setFieldValue('custrecord_ap_lodgement_long', nlapiGetLineItemValue('addresses', 'lng', y));
			// nlapiSubmitRecord(noncust_lodgement_loc_record);
		}
